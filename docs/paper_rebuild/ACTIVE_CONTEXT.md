...
- The current working tree is not yet a frozen CLEAN3 code commit; no final commit hash may be inferred from the base identity.
...
- No S3 parity pass, CLEAN3 code-freeze commit, clean rerun, calibration result, module-effect result, or final CLEAN3 status exists yet.
