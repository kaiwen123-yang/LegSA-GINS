# P-13 v2.1 checkpoint through batch 008

Controller status: `CHECKPOINT_READY`. Closed batches: 8. Native terminals: 2048; evaluator terminals: 4096.
...
Files: `<CODE_ROOT>/docs/paper_rebuild/clean6/P13_THROUGH_BATCH008_BATCHES.csv`, `<CODE_ROOT>/docs/paper_rebuild/clean6/P13_THROUGH_BATCH008_TERMINALS.csv`, `<CODE_ROOT>/docs/paper_rebuild/clean6/P13_THROUGH_BATCH008_EVIDENCE.csv`
