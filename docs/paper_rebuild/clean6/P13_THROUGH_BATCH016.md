# P-13 v2.1 checkpoint through batch 016

Controller status: `CHECKPOINT_READY`. Closed batches: 16. Native terminals: 4096; evaluator terminals: 8192.
...
Files: `<CODE_ROOT>/docs/paper_rebuild/clean6/P13_THROUGH_BATCH016_BATCHES.csv`, `<CODE_ROOT>/docs/paper_rebuild/clean6/P13_THROUGH_BATCH016_TERMINALS.csv`, `<CODE_ROOT>/docs/paper_rebuild/clean6/P13_THROUGH_BATCH016_EVIDENCE.csv`
