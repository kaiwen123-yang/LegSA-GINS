...
- `<BY3_FULL_MATRIX_ROOT>`: BY3 full-matrix runtime root; after BY3B it contains a future execution plan root only, not executed degradation outputs.
