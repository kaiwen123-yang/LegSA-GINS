...
- BY3A8 computed the remaining BY3 yaw error budget and found A1 observation quality is the limiting factor: A1-vs-trace heading RMSE is about 24.06 deg and p95 about 31.78 deg. No safe additional repair passed, no normal rerun was run, and current BY3 recommended next stage is `BY3B_POSITION_UP_WITH_DIAGNOSTIC_YAW_PLANNING`.
