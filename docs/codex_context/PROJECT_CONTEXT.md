...
- Current poor-GNSS recommended next stage: human review of PG_QA0, then keep QA as future work/design extension, approve `PG_QA1_CLASSIFIER_LOGGING_ONLY`, or stop the poor-GNSS line for now.
