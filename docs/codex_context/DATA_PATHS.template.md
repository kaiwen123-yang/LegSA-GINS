...
- Paper-facing evidence review outputs use `<PAPER_EVIDENCE_REVIEW_ROOT>` and `<PAPER0_STAGE_ROOT>`. PAPER0 is evidence organization and claim-boundary review only; runtime outputs and Obsidian notes remain untracked.
