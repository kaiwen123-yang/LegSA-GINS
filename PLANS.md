...
- Current BY3/reporting stage: `BY3A4C_GIT_HISTORY_YAW_REFERENCE_RECONSTRUCTION_AND_VISUAL_VALIDATION`; historical BY2 yaw-reference repair recovered, BY3 yaw marked `not_evaluable`, position/up-only planning allowed for human review.
...
- BY3 yaw source/reference confirmation before any BY3 yaw degradation planning or yaw claim
