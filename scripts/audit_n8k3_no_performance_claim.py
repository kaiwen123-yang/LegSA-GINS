#!/usr/bin/env python3
"""Audit N8K3 makes no performance claim."""

# 中文说明：N8K3 不做 paper performance claim 或 outperform final_v23 claim。
...
def _audit(root: Path) -> int:
    for name in REQUIRED_REPORTS:
        ...
        if payload.get("paper_performance_claim") is not False or payload.get("outperform_final_v23_claim") is True:
            raise SystemExit("audit_n8k3_no_performance_claim failed")
    print("audit_n8k3_no_performance_claim passed")
    return 0
