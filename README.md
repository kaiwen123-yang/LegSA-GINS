...
The BY3 decision is `BY3C_batch0_to_batch3_position_up_degradation_complete`, setting `ready_for_BY3D_diagnostic_yaw_or_mixed_planning=true` only after human review, `yaw_claim_scope=diagnostic_only`, and `ready_for_paper_claims=false`.
