...
The BY3 decision is `BY3A8_yaw_limited_but_position_up_ready`, setting `ready_for_BY3_degradation_matrix_planning=true` with `scope=position_up_with_diagnostic_yaw`, `yaw_claim_scope=diagnostic_only`, and `ready_for_paper_claims=false`.
