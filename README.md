...
The BY3 decision is `BY3B_position_up_diagnostic_yaw_plan_complete`, setting `ready_for_BY3C_position_up_degradation_execution=true` after human review, `yaw_claim_scope=diagnostic_only`, and `ready_for_paper_claims=false`.
