...
The BY3 decision is `BY3A7_yaw_salvaged_ready_for_full_BY3_degradation`, setting `ready_for_BY3_degradation_matrix_planning=true` with `scope=full_after_human_review`, and `ready_for_paper_claims=false`.
