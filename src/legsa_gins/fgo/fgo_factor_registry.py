...
def build_default_factor_registry() -> dict[str, Any]:
    ...
    factors = [
        ...
        FGOFactorContract("DualYawFactor", "dual_antenna", True, False, 1, ("yaw",), "dual_antenna_yaw", "dual_yaw_std"),
        ...
        FGOFactorContract("SmoothnessFactor", "temporal_model", True, False, 9, ("position", "attitude", "velocity"), "neighbor_state", "fixed_temporal_smoothness"),
        ...
        FGOFactorContract("Go2YawRateBetweenFactor", "go2_yawrate", False, True, 1, ("yaw",), "go2_yawrate_candidate", "diagnostic_between_factor_covariance"),
