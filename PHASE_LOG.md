...
| N4H4D2 formula parity and diagnostic variants | stage/N4H4D-clean-replay-parity | done | no | no | formula parity + variant matrix | N4H4D1 diagnostics completed; N4H4D2 formula/variant diagnostics completed; next stage determined by N4H4D2_DECISION_REPORT |
| N4H4D3 source-backed guarded formula fix | stage/N4H4D-clean-replay-parity | done | yes | no | guarded formula replay | N4H4D3 no-improvement result recorded; next stage determined by N4H4D3_DECISION_REPORT |
| N4H4D4 external-clean trace parity and shadow measurement audit | stage/N4H4D-clean-replay-parity | done | no | no | trace parity + shadow audit | N4H4D3 no-improvement result recorded; N4H4D4 trace/shadow diagnostics completed; next stage determined by N4H4D4_DECISION_REPORT |
| N4H4D5 one-step propagation and gain/feedback isolation | stage/N4H4D-clean-replay-parity | done | no | no | gain/feedback isolation | N4H4D4 trace/shadow diagnostics completed; N4H4D5 gain/feedback diagnostics completed; next stage determined by N4H4D5_DECISION_REPORT |
| N4H4D6 IMU error-state feedback and compensation audit | stage/N4H4D-clean-replay-parity | done | no | no | IMU feedback/covariance diagnostics | N4H4D5 gain/feedback diagnostics completed; N4H4D6 IMU error feedback diagnostics completed; next stage determined by N4H4D6_DECISION_REPORT |
