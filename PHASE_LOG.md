...
| N4H4R0 route reset and source-backed port readiness | stage/N4H4R0-route-reset-source-backed-port | in_progress | no | no | route reset docs + readiness audits | source-backed controlled port selected; final_v23 is not proposed; no solver implementation or factors |
| N4H4R1 controlled source-backed KF-GINS/final_v23 core port | stage/N4H4R1-source-backed-core-port | not_started | yes | no | controlled port | N4H4R1 not_started; must preserve provenance and no performance claim |
