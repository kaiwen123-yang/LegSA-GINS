...
| N4R3 dual_final_v23 manual artifact intake and official evaluator parity lock | stage/N4H2C-yaw-config-parity-audit | done | no | no | manual dual artifact intake + parity lock | N4R3 done on PR #13 if validation passes; next recommended stage determined by N4R3_DECISION_REPORT |
