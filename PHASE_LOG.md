...
| N4H2C final_v23 deep source and yaw config parity audit | stage/N4H2C-yaw-config-parity-audit | done | no | no | deep input/source/runtime parity audit | N4H2 done; N4H2C deep parity audit done; next recommended stage determined by N4H2C_DECISION_REPORT; no solver implementation |
