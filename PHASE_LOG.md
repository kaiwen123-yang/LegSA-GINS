...
| N4H2C yaw config parity audit | stage/N4H2C-yaw-config-parity-audit | planned | no | no | yaw config parity audit plan | decision-driven follow-up because N4H2 position passed but yaw failed; no solver implementation |
