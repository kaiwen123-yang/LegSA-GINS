...
def test_locked_queue_uses_m1r2b2_degraded_provider_alias_only():
    path = stage_root() / "04_QUEUE" / "PAPER10M1R2D_R1_INTERNAL_ABLATION_QUEUE_LOCKED.csv"
    ...
    assert not any("paper10m1r2c_r1_v2_by2_full_algorithm_matrix_yaw_corrected" in row["expected_output_root"] for row in rows)
